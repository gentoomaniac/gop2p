...
func (x *NewPeer) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *NewPeer) GetProtocol() string {
	if x != nil {
		return x.Protocol
	}
	return ""
...
var file_protofiles_messages_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x53, 0x0a, 0x07, 0x4e, 0x65,
	0x77, 0x50, 0x65, 0x65, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	...
	0x1f, 0x5a, 0x1d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x65,
	0x6e, 0x74, 0x6f, 0x6f, 0x6d, 0x61, 0x6e, 0x69, 0x61, 0x63, 0x2f, 0x67, 0x6f, 0x70, 0x32, 0x70,
...
var file_protofiles_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_protofiles_messages_proto_goTypes = []interface{}{
	(*Message)(nil), // 0: main.Message
	(*NewPeer)(nil), // 1: main.NewPeer
}
